...
public class DaftarPesananController implements Initializable {
    ...
    @FXML
    private TableView<Pesanan> PegawaiTblView;
    @FXML
    private TableColumn<Pesanan, String> IdPgnClm;
    @FXML
    private TableColumn<Pesanan, String> IdPgwClm;
    @FXML
    private TableColumn<Pesanan, String> namaClm;
    @FXML
    private TableColumn<Pesanan, String> JkClm;
    @FXML
    private TableColumn<Pesanan, String> jalanClm;
    @FXML
    private TableColumn<Pesanan, String> kecClm;
    @FXML
    private TableColumn<Pesanan, String> kotaClm;
    @FXML
    private TableColumn<Pesanan, String> NcClm;
    ...
    private void searchOnEnter() {
        ...
        searchTF.textProperty().addListener((observable, oldValue, newValue) -> {
            filteredData.setPredicate(pesanan -> {
                ...
                if(pesanan.getNama().toLowerCase().contains(lowerCaseFilter)) {
                    return true;
                }
                return false;
